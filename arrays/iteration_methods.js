...
function removeMango (fruit){
    let results = fruits !== "mango";
    return results;
}

const filteredFruit3 = fruit.filter(removeMango);
...
/*
    Challenge:
        How do you removed 5s from an array
        Store it in a new variable and console log that variable
*/

let myNumArray = [1, 5, 6, 4,8, 9, 4, 5];

let newNumArray = myNumArray.filter((num) => num !== 5);
console.log(newNumArray);

let movies = [
    {name: "Top Gun 2", category: "Action"}, {name: "Scary Movie 5", category: "Horro"},
];
...
*/
let movieList = ["Matrix", "Babe", "Little Mermaid", "The Two Twoers"];
...
let newFizzBuzzArray = numArray.filter((num) => num %15 === 0);
console.log("new fizz buzz", new FizzBuzzArray);
